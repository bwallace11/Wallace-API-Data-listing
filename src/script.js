...
const SKETCHES = [
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 50" height="50">
    ...
    <text x="165" y="30" font-family="Caveat,cursive" font-size="11" fill="#4A1515" opacity="0.3" transform="rotate(-1,165,30)">how many more</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 70" height="70">
    ...
    <text x="10" y="45" font-family="Caveat,cursive" font-size="10" fill="#4A1515" opacity="0.25" transform="rotate(-1.5,10,45)">always watching</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 60" height="60">
    ...
    <text x="88" y="22" font-family="Caveat,cursive" font-size="13" fill="#4A1515" opacity="0.25" font-weight="600" transform="rotate(-1,88,22)">WHY WHY WHY WHY WHY WHY</text>
    <text x="88" y="42" font-family="Caveat,cursive" font-size="10" fill="#1C1410" opacity="0.18" transform="rotate(0.5,88,42)">i keep coming back to this</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 55" height="55">
    ...
    <text x="140" y="32" font-family="Caveat,cursive" font-size="12" fill="#1C1410" opacity="0.2" transform="rotate(-0.8,140,32)">these are the ones I know about</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 80" height="80">
    ...
    <text x="90" y="28" font-family="Caveat,cursive" font-size="11" fill="#4A1515" opacity="0.22" transform="rotate(-1.5,90,28)">i know this face</text>
    <text x="90" y="48" font-family="Caveat,cursive" font-size="10" fill="#1C1410" opacity="0.18" transform="rotate(0.5,90,48)">they always look the same</text>
    <text x="90" y="66" font-family="Caveat,cursive" font-size="9" fill="#4A1515" opacity="0.15" transform="rotate(-0.8,90,66)">the eyes. always the eyes.</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 55" height="55">
    ...
    <text x="75" y="22" font-family="Caveat,cursive" font-size="13" fill="#4A1515" opacity="0.22" font-weight="700" transform="rotate(-0.5,75,22)">AGAIN</text>
    <text x="75" y="40" font-family="Caveat,cursive" font-size="10" fill="#1C1410" opacity="0.18" transform="rotate(1,75,40)">and again</text>
    <text x="75" y="54" font-family="Caveat,cursive" font-size="9" fill="#1C1410" opacity="0.14" transform="rotate(-0.5,75,54)">and again</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 45" height="45">
    ...
    <text x="130" y="20" font-family="Caveat,cursive" font-size="11" fill="#4A1515" opacity="0.25" transform="rotate(-2,130,20)">the pattern never stops</text>
    <text x="130" y="38" font-family="Caveat,cursive" font-size="9" fill="#1C1410" opacity="0.18">i can see it now</text>
  </svg>`,
  ...
  `<svg class="inline-sketch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 55" height="55">
    ...
    <text x="175" y="28" font-family="Caveat,cursive" font-size="11" fill="#1C1410" opacity="0.2" transform="rotate(-1)">connected. all connected.</text>
  </svg>`,
];
